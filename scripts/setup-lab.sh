...
echo "  Mission 2.1: Weapon Handling Test"
echo "  Initialising WHT Range + Fleet..."
echo "=============================================="
echo ""
...
for node in wht-ssh:2241 wht-web:2242 sdc-web:2221 sdc-db:2222 sdc-comms:2223; do
    name="${node%%:*}"
    port="${node##*:}"
...
echo ""
echo "=============================================="
echo "  WHT Range: 2 targets ONLINE"
echo "  Fleet:     3 nodes ONLINE"
echo ""
echo "  Private YOLO-Deploy pushed untested code to"
echo "  production. Friday. 16:59. Three nodes down."
echo "  This is why we have the WHT."
echo ""
